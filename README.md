...
為了驗證模型的強健性，我們在不同的干擾條件下進行了對照實驗，比較了 NeurIPS 的 IDQN、CIKM 的 CoLight 以及我們提出的 STGATDQN。
  ...
  ![5m-8m Time Loss Comparison](images
/STGATDQN_5m-8m_TimeLoss.png)
  
  #### 實驗二：資訊延遲 (Network Latency) 下的表現
  當交通號誌與伺服器之間存在傳輸延遲時，STGATDQN 依然能保持穩定的決策，避免了交通擁塞的惡化：
  
  ![Delay Time Loss Comparison](images
/STGATDQN_DelayTimeLoss.png)
  ...
  ![Phase Length Stability](images
/STGATDQN_5m-8m_PhaseLength .png)
